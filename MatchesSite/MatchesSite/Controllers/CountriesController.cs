...
namespace MatchesSite.Controllers
{
	...
	public class CountriesController : Controller
    {
        ...
        public CountriesController(MatchesDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Flag")] Countries countries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Flag")] Countries countries)
        {
            if (id != countries.Id)
            {
                return NotFound();
